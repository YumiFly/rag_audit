...
export default function Navigation({ healthStatus, isLoading }: NavigationProps) {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-gray-700/50 bg-gray-800/50 backdrop-blur-lg">
